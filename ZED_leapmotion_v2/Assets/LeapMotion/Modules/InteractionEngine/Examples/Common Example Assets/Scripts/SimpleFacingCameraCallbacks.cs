...
namespace Leap.Unity.Examples {
  ...
  public class SimpleFacingCameraCallbacks : MonoBehaviour {
    ...
    private void initialize() {
      ...
      _isFacingCamera = !GetIsFacingCamera(toFaceCamera, ZEDCamera);
      _initialized = true;
    }
    ...
    void Update() {
      ...
      if (GetIsFacingCamera(toFaceCamera, ZEDCamera, _isFacingCamera ? 0.77F : 0.82F) != _isFacingCamera) {
    ...
    public static bool GetIsFacingCamera(Transform facingTransform, GameObject camera, float minAllowedDotProduct = 0.8F) {
